...
<div id="portlet1" class="panel-collapse collapse in">
  ...
  <tr>
    <td width="28%">&nbsp;</td>
     <td width="41%">
   <center>
       Selamat datang, <b><?=$this->session->userdata('username');?></b> di halaman dashboard Ahli Gizi. Pada aplikasi ini Anda dapat melihat data semua Permintaan Bahan <br /> yang telah Diajukan. Anda juga dapat mengedit data permintaan Bahan<br/> serta mencetak laporan Permintaan Bahan <br />
      <br>
 ...
 <div class="row">
  ...
  <?php 
    foreach ($cek_barang as $cek) {
         $cek['bahan'] = $cek['stok_tersedia'];
     if($cek['bahan'] <=$cek['jml_minimal'] ){
     ?>
