...
?>
 ...
 <div class="clearfix"></div>
  ...
  <div id="portlet1" class="panel-collapse collapse in">
      ...
      <div class=" form">
    <form class="cmxform form-horizontal tasi-form" method="POST" action="<?=base_url('ahli_gizi/laporan_mk');?>">
...
<div class="col-sm-6">
     <div class="m-b-30">
     <br><a class="btn btn-primary waves-effect waves-light" href="<?=base_url('ahli_gizi/export');?>/<?=$jenis_laporan."/".$tgl_awal."/".$tgl_akhir;?>" target="_blank"><i class="fa  fa-print"></i> Cetak Laporan</a>
 </div>
   </div>
