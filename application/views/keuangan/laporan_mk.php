...
<div class="portlet-body">
     <div class=" form">
     <form class="cmxform form-horizontal tasi-form" method="POST" action="<?=base_url('keuangan/laporan_mk');?>">
   <div class="form-group">
     <label class="control-label col-lg-2">Laporan Bahan Makanan</label>
  <div class="col-lg-10">
   <select class=" form-control select2" data-placeholder="Nama Barang" id="jenis_laporan" name="jenis_laporan" required>
...
<input type="date" class="form-control" placeholder="Tanggal Akhir" name="tgl_akhir" id="tgl_akhir" required value="<?=date('Y-m-d')?>"> 
 ...
 <div class="form-group">
  ...
  <button class="btn btn-primary waves-effect waves-light" id="sbm" name="submit" type="submit">Cari</button>
    </div>
   </div>
  </form>
 </div> <!-- .form -->
...
<div class="col-sm-6">
  <div class="m-b-30">
<br><a class="btn btn-primary waves-effect waves-light" href="<?=base_url('keuangan/export');?>/<?=$jenis_laporan."/".$tgl_awal."/".$tgl_akhir;?>" target="_blank"><i class="fa fa-print"></i> Cetak Laporan</a>
 </div>
 </div>
 ...
 foreach ($data_laporan as $laporan) {
  ...
  <tr id="hps">
 <td><?=$no++;?></td>
   <td><?=tgl_indo(tgl_database($laporan['tgl']));?></td>
