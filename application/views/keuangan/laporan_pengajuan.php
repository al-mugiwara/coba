 ...
 <ol class="breadcrumb pull-right">
  ...
  <div class="clearfix"></div>
   ...
   <div id="portlet1" class="panel-collapse collapse in">
     ...
     <div class=" form">
    <form class="cmxform form-horizontal tasi-form" method="POST" action="<?=base_url()?>keuangan/cetak_pengajuan/cetak_semua">
             ...
             <td><?=$pengajuan['jml_tersisa'];?></td>
              <td><?=$pengajuan['jml_ajuan'];?></td>
               <td><?=$pengajuan['status_ajuan'];?></td>
                 <td>
                    <a href="<?=base_url()?>keuangan/cetak_pengajuan/<?=$pengajuan['id_pengajuan'];?>" class="btn btn-inverse" target="_blank"> <i class="ion-printer"></i></a></td>
             </tr>
            <?php 
             }
       ?> 
