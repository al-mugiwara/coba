 ...
 <h3 class="portlet-title text-uppercase">
  ...
  <div class="clearfix"></div>
   ...
   <div class="portlet-body">
      <div class=" form">
    <form class="cmxform form-horizontal tasi-form" method="POST" action="<?=base_url('logistik/fifo');?>">
...
<div class="col-lg-2">
 ...
 <div class="form-group">
  ...
  <div class="col-sm-6">
        <div class="m-b-30">
              <br><a class="btn btn-primary waves-effect waves-light" href="<?=base_url('logistik/export_fifo');?>/<?=$jenis_laporan."/".$tgl_awal."/".$tgl_akhir;?>" target="_blank"><i class="fa fa-print"></i> Cetak Laporan</a>
         </div>
   </div>
