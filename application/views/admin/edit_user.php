...
<div class="row">
 ...
 <div class="panel-heading"><h3 class="panel-title text-white">Form Edit Pengguna</h3></div>
   <div class="panel-body">
<div class=" form">
   <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST" enctype="multipart/form-data" action="<?=base_url();?>admin/save_edit" novalidate="novalidate">
 ...
 <div class="form-group ">
  ...
  <div class="form-group">
     ...
     <div class="col-lg-10">
  <select class=" form-control select2" data-placeholder="Pilih Akses" id="hak_akses" name="hak_akses" required onclick="validasi()">
...
<div class="form-group">
    ...
    <button class="btn btn-success waves-effect waves-light" id="sbm" type="submit">Simpan</button>
      <a href="<?=base_url('admin/user_management');?>" class="btn btn-default waves-effect">Batal</a>
   </div>
 </div>
    </form>
   </div> <!-- .form -->
